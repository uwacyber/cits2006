...
```
wget https://github.com/uwacyber/cits2006/raw/2026/cits2006-labs/files/oneway.py
```
...
```
wget https://github.com/uwacyber/cits2006/raw/2026/cits2006-labs/files/collisionfree.py
```
...
```
wget https://github.com/uwacyber/cits2006/raw/2026/cits2006-labs/files/blockchain.py
```

And you will need this for creating new transactions later:

```
wget https://github.com/uwacyber/cits2006/raw/2026/cits2006-labs/files/blockchain_transaction.py
```
