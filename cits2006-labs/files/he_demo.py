...
# ciphertext modulus
q = 2**20
# plaintext modulus, numbers cannot be larger than this
t = 2**10
# polynomial modulus
...
print(f"[+] Decrypted ct3(ct1({pt1}) + {cst1:2}): {decrypted_ct3}")
print(f"[+] Decrypted ct4(ct2({pt2}) * {cst2:2}): {decrypted_ct4}")
